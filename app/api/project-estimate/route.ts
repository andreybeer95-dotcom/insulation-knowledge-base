...
function buildRoofSlopeGuidance(text: string, question: string, layers: DetectedLayer[]) {
  ...
  return {
    ...
    calculatorUrl: "https://nav.tn.ru/calculators/wedge-insulating/",
    rules: [
      ...
      "NAV.TN-калькулятор клиновидной теплоизоляции считает объем клиновидной изоляции, количество и типоразмер крепежа, схему раскладки плит и толщины утеплителя.",
...
function buildQuoteDraft(summary: {
  ...
  if (summary.roofSlopeGuidance?.shouldMention) {
    ...
    lines.push("- NAV.TN-калькулятор уклонов должен давать объем клиновидной изоляции, типоразмер крепежа, раскладку плит и толщины;");
